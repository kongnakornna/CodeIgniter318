...
*/
$url='/cihmvcdev3/';
$config['www']='http://'.$_SERVER['HTTP_HOST'].$url;
$config['api']='http://'.$_SERVER['HTTP_HOST'].$url;
$config['base_url']='http://'.$_SERVER['HTTP_HOST'].$url;
$config['base_path']='http://'.$_SERVER['HTTP_HOST'].$url;
...
#$config['sess_save_path'] = $config['base_url'].'file/session/'; 
#$config['sess_driver'] = 'database';
#$config['sess_save_path'] = 'na_session_'; //NULL;

$config['sess_cookie_name'] = 'cihmvcdev3_session_';
$config['sess_expiration'] = 7200;
$config['sess_match_ip'] = FALSE;
$config['sess_time_to_update'] = 300;
$config['sess_regenerate_destroy'] = FALSE;
